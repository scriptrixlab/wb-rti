  ...
  return (
    <>
      <nav
        ...
        style={{background: 'rgb(174,206,241)',
          background: 'linear-gradient(90deg, rgba(174,206,241,1) 0%, rgba(7,125,159,1) 0%, rgba(240,242,142,1) 100%, rgba(87,147,186,0.08727240896358546) 100%, rgba(180,220,232,1) 100%)'}}>
      ...
      <div
        ...
        <div className="form-group mx-auto" style={{width:'100px'}}>
          <input className="form-control rounder-5" type='text' placeholder="Name" value='Member'/>
        </div>
